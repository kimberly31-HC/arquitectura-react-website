...
import cliente5 from "../assets/img/clientes/cliente5.jpg";
import cliente6 from "../assets/img/clientes/cliente6.jpg";
import cliente7 from "../assets/img/clientes/cliente7.png";
...
const ClientesTrompo = () => {
  const clientes = [
    ...
    { id: 7, logo: cliente7, alt: "Cliente 7" },
  ];
            ...
            <div className="clientes-trompo__stage">
              <div className="clientes-trompo__carousel">
                {clientes.concat(clientes).map((cliente, index) => (
                  <div key={cliente.id} className="clientes-trompo__item">
                    <img src={cliente.logo} alt={cliente.alt} className="clientes-trompo__logo" loading="lazy" />
                  </div>
                ))}
              </div>
            </div>
